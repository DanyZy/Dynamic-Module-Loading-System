...
class ModuleFetcher(private val pathtobin: String) {

    public fun fetchPluginsFromJar(): List<JarEntry?> {
    ...
    public fun fetchMainClass(name: String?, args: Array<String?>): Method? {
        return try {
    ...
    public fun fetchMainClassName(): String? {
        val url: URL = URL("jar", "", -1, "file:$pathtobin!/")
